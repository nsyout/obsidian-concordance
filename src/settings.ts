...
export class ConcordanceSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    new Setting(containerEl).setName("Prefix mode defaults").setHeading();
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .onChange(async (value) => {
            this.plugin.settings.childFilenamePrefixTemplate = value.trim();
            await this.plugin.saveSettings();
          }),
      );

    new Setting(containerEl).setName("Generated block markers").setHeading();
    ...
    new Setting(containerEl)
      .setName("End marker")
      .setDesc("Marks the end of plugin-owned content. Content outside markers is never changed.")
      .addText((text) =>
        text
    ...
    new Setting(containerEl).setName("Global exclusions").setHeading();
    ...
    new Setting(containerEl)
      ...
      .addTextArea((textArea) => {
        textArea
          ...
          .onChange(async (value) => {
            this.plugin.settings.excludedFolders = parseLines(value);
            await this.plugin.saveSettings();
          });
    ...
    new Setting(containerEl)
      ...
      .addTextArea((textArea) => {
        textArea
          ...
          .onChange(async (value) => {
            this.plugin.settings.excludedFilenameTerms = parseLines(value);
            await this.plugin.saveSettings();
          });
        textArea.inputEl.rows = 6;
      });
